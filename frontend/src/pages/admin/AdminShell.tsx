    ...
    <div className="min-h-screen bg-cream flex">
      <aside className="w-52 shrink-0 bg-forest text-cream flex flex-col">
        ...
        <div className="p-3 border-t border-cream/10 space-y-1">
          <NavLink
            to="/"
            className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-cream/70 hover:bg-cream/5 hover:text-cream transition-colors"
          >
            &larr; Student App
          </NavLink>
          <NavLink
          ...
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-danger/80 hover:bg-cream/5 hover:text-danger transition-colors cursor-pointer"
          >
